...
public class menu_empleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Panel_cajero = new javax.swing.JPanel();
        Label_cajero = new javax.swing.JLabel();
        Panel_info_asegurados = new javax.swing.JPanel();
        info_asegurados_Label = new javax.swing.JLabel();
        ...
        Label_titulo.setText("MENU CAJEROS");
        ...
        Panel_cajero.setBackground(new java.awt.Color(64, 153, 167));
        Panel_cajero.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Panel_cajero.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Panel_cajeroMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                Panel_cajeroMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                Panel_cajeroMouseExited(evt);
            }
        });

        Label_cajero.setFont(new java.awt.Font("Roboto Medium", 0, 24)); // NOI18N
        Label_cajero.setForeground(new java.awt.Color(255, 255, 255));
        Label_cajero.setText("Cajeros");

        javax.swing.GroupLayout Panel_cajeroLayout = new javax.swing.GroupLayout(Panel_cajero);
        Panel_cajero.setLayout(Panel_cajeroLayout);
        Panel_cajeroLayout.setHorizontalGroup(
            Panel_cajeroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Panel_cajeroLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(Label_cajero, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(154, Short.MAX_VALUE))
        );
        Panel_cajeroLayout.setVerticalGroup(
            Panel_cajeroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Label_cajero, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
        );

        Panel_info_asegurados.setBackground(new java.awt.Color(64, 153, 167));
        Panel_info_asegurados.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Panel_info_asegurados.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Panel_info_aseguradosMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                Panel_info_aseguradosMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                Panel_info_aseguradosMouseExited(evt);
            }
        });

        info_asegurados_Label.setFont(new java.awt.Font("Roboto Medium", 0, 20)); // NOI18N
        info_asegurados_Label.setForeground(new java.awt.Color(255, 255, 255));
        info_asegurados_Label.setText("Informacion de asegurados");

        javax.swing.GroupLayout Panel_info_aseguradosLayout = new javax.swing.GroupLayout(Panel_info_asegurados);
        Panel_info_asegurados.setLayout(Panel_info_aseguradosLayout);
        Panel_info_aseguradosLayout.setHorizontalGroup(
            Panel_info_aseguradosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Panel_info_aseguradosLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(info_asegurados_Label)
                .addContainerGap())
        );
        Panel_info_aseguradosLayout.setVerticalGroup(
            Panel_info_aseguradosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(info_asegurados_Label, javax.swing.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
        );
        ...
        Panel_MenuLayout.setHorizontalGroup(
            ...
            .addComponent(Panel_cajero, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(Panel_info_asegurados, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        Panel_MenuLayout.setVerticalGroup(
            Panel_MenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Panel_MenuLayout.createSequentialGroup()
                .addComponent(Panel_cajero, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Panel_info_asegurados, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void Panel_cajeroMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_cajeroMouseEntered
        Color color1 = new Color (64,130,142);
        Panel_cajero.setBackground(color1);
    }//GEN-LAST:event_Panel_cajeroMouseEntered

    private void Panel_cajeroMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_cajeroMouseExited
        Color color2 = new Color (64,153,167);
        Panel_cajero.setBackground(color2);
    }//GEN-LAST:event_Panel_cajeroMouseExited

    private void Panel_cajeroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_cajeroMouseClicked
        mostrar_panel(new menu_cajeros());
    }//GEN-LAST:event_Panel_cajeroMouseClicked

    private void Panel_info_aseguradosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_info_aseguradosMouseClicked
        try {
            mostrar_panel(new ver_asegurados_en_cola());
        } catch (ParseException ex) {
            Logger.getLogger(menu_empleados.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_Panel_info_aseguradosMouseClicked

    // Eventos de entrada y salida del mouse para el botón de perfil
    private void Panel_info_aseguradosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_info_aseguradosMouseEntered
        Color color1 = new Color (64,130,142);
        Panel_info_asegurados.setBackground(color1);
    }//GEN-LAST:event_Panel_info_aseguradosMouseEntered

    private void Panel_info_aseguradosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_info_aseguradosMouseExited
        Color color2 = new Color (64,153,167);
        Panel_info_asegurados.setBackground(color2);
    }//GEN-LAST:event_Panel_info_aseguradosMouseExited
...
public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            new menu_empleados(null).setVisible(true);
        }
    });
}
...
public String getName() {
    ...
    private javax.swing.JPanel Panel_cajero;
    private javax.swing.JPanel Panel_info_asegurados;
    ...
    private javax.swing.JLabel info_asegurados_Label;
