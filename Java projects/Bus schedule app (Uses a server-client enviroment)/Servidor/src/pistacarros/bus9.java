        ...
        while (Cronometro_frame.isActivo()) {
          ...
          if (i == 1) {
              //mueve el bus a donde debe ir
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
            ...
            if (i == 2) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(70,155);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 3) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(85,164);
            ...
            if (i == 4) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(102,163);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 5) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(124,163);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 6) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(144,169);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 7) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(159,182);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 8) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(168,194);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 9) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(182,211);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 10) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(196,220);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 11) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(209,224);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 12) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(226,232);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 13) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(240,241);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 14) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(256,254);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 15) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(280,258);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 16) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(299,254);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 17) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(317,249);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 18) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(335,245);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 19) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(348,243);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 20) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(362,242);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 21) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(377,237);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 22) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(391,241);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 23) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(405,249);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 24) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(421,254);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 25) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(436,263);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 26) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(445,277);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 27) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(460,287);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 28) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(464,305);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 29) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(467,324);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 30) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(475,349);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 31) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(492,356);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 56) {
                Interfaz.nueve.setIcon(new ImageIcon(Interfaz.img9));
                Interfaz.nueve.setLocation(144,159);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
