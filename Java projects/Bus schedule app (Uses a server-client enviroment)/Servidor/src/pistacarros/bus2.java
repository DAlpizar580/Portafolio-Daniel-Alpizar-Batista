    ...
    public void run() {
        ...
        while (Cronometro_frame.isActivo()) {
         ...
         if (i == 1) {
            ...
            if (i == 2) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(70,155);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 3) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(85,164);
            ...
            if (i == 4) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(102,163);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 5) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(124,163);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 6) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(144,169);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 7) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(159,182);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 8) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(168,194);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 9) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(182,211);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 10) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(196,220);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 11) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(209,224);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 12) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(226,232);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 13) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(240,241);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 14) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(256,254);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 15) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(280,258);
                try { Thread.sleep(3000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 16) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(299,254);
                try { Thread.sleep(1000);
                }catch(InterruptedException ex){
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 17) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(317,249);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 18) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(335,245);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 19) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(348,243);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 20) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(362,242);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 21) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(377,237);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 22) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(391,241);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 23) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(405,249);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 24) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(421,254);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 25) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(436,263);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 26) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(445,277);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 27) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(460,287);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 28) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(464,305);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 29) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(467,324);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 30) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(475,349);
                try { Thread.sleep(3000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 31) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(492,356);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
            ...
            if (i == 56) {
                Interfaz.dos.setIcon(new ImageIcon(Interfaz.img2));
                Interfaz.dos.setLocation(144,159);
                try { Thread.sleep(1000);
                } catch (InterruptedException ex) {
                    Logger.getLogger(bus2.class.getName()).log(Level.SEVERE, null, ex);
                }
