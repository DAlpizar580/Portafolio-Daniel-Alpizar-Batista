...
import Paginas_menu.ver_datos_pacientes;
import Paginas_menu.consulta_a_doctor;
import Paginas_menu.cita_pacientes;
...
public class menu_pacientes extends javax.swing.JFrame {
     ...
     */
    public menu_pacientes(String NAME) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Label_titulo.setText("MENU PACIENTES");
        ...
        Label_sacar_citas.setText("Sacar Cita");
        ...
        Panel_citasLayout.setHorizontalGroup(
            ...
            .addGroup(Panel_citasLayout.createSequentialGroup()
                ...
                .addComponent(Label_sacar_citas, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Consulta_Label.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        Consulta_Label.setForeground(new java.awt.Color(255, 255, 255));
        Consulta_Label.setText("Consulta a doctor");
        ...
        Panel_ConsultaLayout.setHorizontalGroup(
            ...
            .addGroup(Panel_ConsultaLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(Consulta_Label, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(40, Short.MAX_VALUE))
        );
        Panel_ConsultaLayout.setVerticalGroup(
            Panel_ConsultaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Consulta_Label, javax.swing.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
            .addGroup(Panel_ConsultaLayout.createSequentialGroup()
                .addComponent(Consulta_Logo, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void Panel_citasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_citasMouseClicked
        mostrar_panel(new cita_pacientes(name));
    ...
    private void Panel_ConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_ConsultaMouseClicked
        mostrar_panel(new consulta_a_doctor(name));
    ...
    private void ProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ProfileMouseClicked
        mostrar_panel(new ver_datos_pacientes(this.name));
...
public static void main(String args[]) {
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            new menu_pacientes(null).setVisible(true);
        }
    });
}
