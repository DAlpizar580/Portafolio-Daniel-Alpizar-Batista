 ...
 * @author Daniel
 */
public class modificar_doctores1 extends javax.swing.JPanel {

    
    public modificar_doctores1() {
        initComponents();
        for (Doctor persona : Info_Cuentas.getCuentasDoctores())
        {
            doctores.addItem(persona.getNombre());
        }
    ...
    private void initComponents() {
        ...
        doctor_eliminado.setText("Doctor eliminado");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(txt_field_años_experiencia))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Label_direccion))
                    .addComponent(txt_field_años_experiencia, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Label_telefono)
    ...
    private void Panel_botonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_botonMouseClicked
        if (String.valueOf(txt_field_cedula.getText()).length() == 9 || String.valueOf(txt_field_cedula.getText()).equals("Ingrese la cedula"))
        {
            for(Doctor persona : Info_Cuentas.getCuentasDoctores())
            {
                if(persona.getNombre().equals(doctores.getSelectedItem().toString()))
                {
                    ...
                    if (!String.valueOf(txt_field_años_experiencia.getText()).equals("Ingrese los años de experiencia") && !String.valueOf(txt_field_años_experiencia.getText()).isEmpty())
                        persona.setAñosExperiencia(Integer.parseInt(txt_field_años_experiencia.getText()));
                    ...
                    if (!String.valueOf(txt_field_especialidad.getText()).equals("Ingrese la especialidad") && !String.valueOf(txt_field_especialidad.getText()).isEmpty())
                        persona.setEspecialidad(String.valueOf(txt_field_especialidad.getText()));
                    if (!String.valueOf(txt_field_titulo.getText()).equals("Ingrese el titulo") && !String.valueOf(txt_field_titulo.getText()).isEmpty())
                        persona.setTitulo(String.valueOf(txt_field_titulo.getText()));
                }
            }
            ...
            for(Doctor persona : Info_Cuentas.getCuentasDoctores())
                {
                    if(persona.getNombre().equals(doctores.getSelectedItem().toString()))
                    {
                        Info_Cuentas.getCuentasDoctores().remove(persona);
