 ...
 * @author Daniel
 */
public class ingresar_empleados extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        info_editada.setText("Empleado añadido");
    ...
    private void Panel_botonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Panel_botonMouseClicked
        ...
        {
            Empleado empleado = new Empleado(String.valueOf(txt_field_cedula.getText()), String.valueOf(txt_field_nombre.getText()), String.valueOf(txt_field_contraseña.getText()), String.valueOf(txt_field_tipo_empeado.getText()), String.valueOf(txt_field_años_observaciones.getText()), String.valueOf(txt_field_estado.getText()));
            Info_Cuentas.getCuentasEmpleados().add(empleado);
