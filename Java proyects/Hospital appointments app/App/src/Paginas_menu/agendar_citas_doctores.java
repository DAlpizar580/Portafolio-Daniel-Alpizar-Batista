 ...
 * @author Daniel
 */
public class agendar_citas_doctores extends javax.swing.JPanel {
     ...
     */
    public agendar_citas_doctores(String name) {
        initComponents();
    ...
    public void enviar_correo ()
    {
        ...
        String paciente = box_paciente.getSelectedItem().toString();
        ...
        String cuerpo = "Confirmacion de cita medica con las siguientes especificaciones: " + "\n \n" +
                        "Nombre del paciente: " + box_paciente.getSelectedItem().toString() + "\n" +
                        "Nombre del doctor: " + this.name + "\n" +
                        "Fecha: " + date1 + "\n" +
    ...
    private void initComponents() {
        ...
        box_paciente = new javax.swing.JComboBox<>();
        ...
        box_paciente.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        box_paciente.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Emma", "Rosa", "Isaac" }));
        box_paciente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                box_pacienteMouseClicked(evt);
            }
        });
        box_paciente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                box_pacienteActionPerformed(evt);
            }
        });

        label_doctor.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        label_doctor.setText("Paciente:");
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(box_paciente, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
    ...
    private void box_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_box_pacienteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_box_pacienteActionPerformed
...
if (fecha.getCalendar() != null) {
    ...
    // Obtiene la hora, el paciente y el motivo de la cita
    ...
    if (date.comparar(año, mes, dia)) {
        ...
        String salida = agendar.agendar_cita(año, mes, dia, hora, this.name, motivo, paciente, date1);
        ...
        switch (salida) {
            ...
            case "paciente":
                mensaje.setForeground(Color.red);
                mensaje.setText("El paciente está ocupado a esa hora, elige otra hora");
                break;
            default:
                break;
        }
    ...
    private void box_pacienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_box_pacienteMouseClicked
        mensaje.setText("");
    }//GEN-LAST:event_box_pacienteMouseClicked
    ...
    private javax.swing.JComboBox<String> box_paciente;
